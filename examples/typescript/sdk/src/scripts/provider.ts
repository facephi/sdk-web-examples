 ...
 *
 */
import type { ErrorData, ExportData } from "@facephi/sdk-web-wc";
...
export function demo() {
	...
	function onEmitData(eventData: CustomEvent<ExportData>) {
	...
	function onEmitError(eventData: CustomEvent<ErrorData>) {
		const result = eventData.detail;
