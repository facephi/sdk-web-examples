...
const LOGGER_COLORS = {
	...
	[LoggerType.SDK_LOADER]: {
		light: { text: '#0d9488', background: '#f0fdfa' },
		dark: { text: '#99f6e4', background: '#115e59' },
	},
...
class Logger {
	 ...
	 * @param {string} loggerLvl LoggerType: 'selphi' | 'selphid' | 'sdk_loader' | etc.
	 * @param {string} message The message you want to display
	 * @param {any} result The result of the event
	 */
