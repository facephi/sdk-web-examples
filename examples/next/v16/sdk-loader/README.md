# SDK-Loader in Next 16

Integration of the `@facephi/sdk-loader` package with Next.js 16.
...
> [!IMPORTANT]
> **Turbopack Compatibility**: Next.js 16 uses Turbopack by default, which has compatibility issues with Stencil web components (used by Facephi SDK). The build script uses the `--webpack` flag to force webpack instead of Turbopack.
...
> [!IMPORTANT]  
> When styling Web Components in Next.js 16, use global CSS with CSS variables as documented in the SDK documentation.
