...
> [!IMPORTANT]
> If you want to get the recorded video when the process is finished, remember to add the video recording URL and the video recording API key provided by the Facephi team to the **.env** file. This file must be created by the user and must contain the variables **NG_APP_VIDEO_RECORDING_URL** and **NG_APP_VIDEO_RECORDING_API_KEY**.
