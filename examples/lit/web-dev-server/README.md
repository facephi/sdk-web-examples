# SDK Web WebComponents in LitElements with Rollup + Web Dev Server.

Integration with LitElements + Rollup + Web Dev Server
...
To use the Facephi SDK Provider, you must pass the `licenseKey` property to the `LitSdkComponent`. The license key is required for the SDK to function properly and should be provided by the Facephi team.
